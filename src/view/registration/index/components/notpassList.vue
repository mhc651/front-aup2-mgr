...
<template>
  <div class="wrap">
    ...
    <el-button type="primary" @click="withdraw" class="bottomButton">撤回</el-button>
    <!--<el-button type="primary" @click="disqualification" class="bottomButton">取消资格</el-button>-->

    <!--撤回审核-->
    <withdraw :id="currentId"
              v-model="showWithdrawDialog"
              url="aup2mgr/api/project/revokeRegisterInfo"
              @success="getRegistrationList"/>
  ...
  export default {
    ...
    data() {
      return {
        param: {
          ...
          auditStatus: 5,           // 审核状态,//1:待提交,2:待审核,3:审核中,4:审核通过,5:审核未通过
          page: 1,                  // 页码-1
          size: 25,                 // 每页数据条数-20
          total: 0,                 // 总条数
        },
    ...
    methods: {
      ...
      withdraw() {
        ...
        this.currentId = this.registrationSelection[0].id
      ...
      audit(e) {
        ...
        this.$router.push('/registrationAudit?id=' + this.registrationSelection[0].id)
      },
