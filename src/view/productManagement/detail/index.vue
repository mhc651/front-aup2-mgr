    ...
    methods: {
      ...
      async getDetail() {
        ...
        if (res.success) {
          ...
          if (res.content.data.attributeJson) {
            this.detailData = Object.assign({}, this.detailData, JSON.parse(res.content.data.attributeJson))
            console.log(JSON.parse(res.content.data.attributeJson), this.detailData )
          }
        } else {
