  ...
  <div class="wrap">
    ...
    <el-tabs type="border-card"   v-model="activeIndex" @tab-click="toClickTab">
      <el-tab-pane label="待审核" name="1">
        <pendingList :productList="productList"/>
      </el-tab-pane>
      <el-tab-pane label="审核中" name="2">
        <auditingList :productList="productList" :toChange="toChange"/>
      </el-tab-pane>
      <el-tab-pane label="未通过" name="3">
        <notPassList :productList="productList"  @change="change"/>
      </el-tab-pane>
      <el-tab-pane label="已通过" name="4">
        <hasPassList :productList="productList"  @change="change"/>
      </el-tab-pane>
      <!--<el-tab-pane label="取消资格">取消资格</el-tab-pane>-->
    </el-tabs>
  </div>
</template>
<script>
