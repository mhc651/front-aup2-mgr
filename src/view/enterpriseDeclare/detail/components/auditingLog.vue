...
<template>
  <div class="wrap">
    ...
    <el-table
      ...
      <el-table-column prop="userId" label="操作人账号" width="100"></el-table-column>
      ...
      <el-table-column label="附件">
        <template slot-scope="scope">
          <a v-for="(item,index) in scope.row.auditFileList"
             :key="index"
             :href="item.url">
            {{ item.name }}
          </a>
  ...
  export default {
    ...
    methods: {
      ...
      async getAuditingLogList() {
        ...
        let url = 'aup2mgr/api/project/findAuditLogForPage'
